...
},{}],"panel/Search.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    rebuild: function rebuild() {
      var text = this.$t("search.index.missing");
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _this.$api.post("search");

              case 4:
                _this.$store.dispatch("notification/success", _this.$t("search.index.built"));
    ...
    search: function search(query) {
      ...
      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                _this2.items = response.data.map(function (item) {
                  ...
                  if (item.hasOwnProperty("email")) {
                    ...
                    data.link = _this2.$api.users.link(item.id);
                    ...
                    data.link = _this2.$api.files.link(_this2.$api.pages.url(item.parent.id), item.filename);
                    data.info = item.id;
                  } else {
                    data.title = item.title;
                    data.link = _this2.$api.pages.link(item.id);
                    data.info = item.id;
                  }
              ...
              case 10:
                ...
                if (_context2.t0.key === "error.notFound") {
                  _this2.hasIndex = false;
                }
              ...
              case 14:
                ...
                _this2.hasResults = _this2.items.length > 0;
        ...
        }, _callee2, null, [[1, 10, 14, 19]]);
      }))();
    }
  }
};
exports.default = _default;
        var $cbcb40 = exports.default || module.exports;
      
      if (typeof $cbcb40 === 'function') {
        $cbcb40 = $cbcb40.options;
      }
    
        /* template */
        Object.assign($cbcb40, (function () {
          var render = function() {
  var _vm = this
        ...
        ? _c("div", { staticClass: "k-search-results" }, [
            _vm.items.length
              ...
              ? _c(
                  "p",
                  {
                    staticClass: "k-search-empty k-search-index",
                    on: { click: _vm.index }
                  },
                  [_vm._v("\n        " + _vm._s(_vm.rebuild) + "\n      ")]
                )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cbcb40', $cbcb40);
          } else {
            api.reload('$cbcb40', $cbcb40);
          }
        }
...
var _Search = _interopRequireDefault(require("./panel/Search.vue"));
...
},{"./panel/Search.vue":"panel/Search.vue"}],"../../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
